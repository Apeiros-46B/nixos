# from https://github.com/poach3r/nixpkgs/commit/c09be1a2904a565f1cd953631fba803cf804c4ff
# waiting for it to be merged upstream
{ config, lib, pkgs, ... }:

let
  cfg = config.programs.widevine-cdm;

  # Patch a Chromium-family browser with the Widevine CDM.
  #
